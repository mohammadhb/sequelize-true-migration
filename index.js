            ...
            if(!verification.verify) {
                ...
                if(verification.err instanceof CharMaxLengthMismatchError) {
                    ...
                    if(modelMatch.references){
                        ...
                        const refrenceKey = Object.keys(this.modelList).find(modelKey=>modelMatch.references.model==this.modelList[modelKey].options.tableName);
                        let refrenceValue;

                        if(refrenceKey){

                            refrenceValue = this.modelList[refrenceKey];
